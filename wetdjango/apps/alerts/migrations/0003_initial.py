...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alerts_alertspluginmodel', (
            ...
            ('alert_type', self.gf('django.db.models.fields.CharField')(default='', max_length=32)),
            ('alert_title', self.gf('django.db.models.fields.CharField')(default='', max_length=32)),
            ('alert_msg', self.gf('django.db.models.fields.CharField')(default='', max_length=32)),
        ))
    ...
    models = {
        'alerts.alertspluginmodel': {
            'Meta': {'object_name': 'AlertsPluginModel', '_ormbases': ['cms.CMSPlugin']},
            'alert_msg': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),
            'alert_title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),
            'alert_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),
